    ...
    public class CAP4a
    {
        public static bool make_CAP4axml(string strIdRol)
        {
            try
            {
                ...
                //scriu xml
                XmlWriter xmlWriter = XmlWriter.Create(AppDomain.CurrentDomain.BaseDirectory.ToString() + "XML\\CAP4a\\" + AjutExport.numefisier(strIdRol) + "xml", settings);
                //header
                ...
                //capitolul
                xmlWriter.WriteStartElement("capitol_4a");         //deschid5
                ...
                while (drXML.Read())
                {
                        ...
                        xmlWriter.WriteStartElement("cultura_in_camp");         //deschid6
